/**
* Hand/waist detection with Kinect Sensor and draw particle system with DLA
*
* @author WenChi Huang
* @date 2021/1/8
*/
...
//set thresholds for finger tracker, point and body
int threshold = 625;
float thresholdPoint = 5;
...
void draw() {
   ...
   //get average point of body as waist
